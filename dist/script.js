        ...
        "+": () => {
            ...
            return ((_a = {
                ...
                "object": () => {
                    ...
                    }[toString.call(input)]) !== null && _a !== void 0 ? _a : (() => [false, cxp, apps]))();
                }
            }[typeof input]) !== null && _a !== void 0 ? _a : (() => [false, cxp, apps]))();
        },
        "-": () => [false, cxp, apps] // sentinel to output
    }[cxp[0]]) !== null && _a !== void 0 ? _a : (() => [false, cxp, apps]))();
};
...
const genOutputData = (cxpOrg, input) => {
    const cxp = (!(!input) || input === false) ? [
        "app",
        cloneCXP(cxpOrg),
        ["+", input, void 0, void 0],
        void 0
